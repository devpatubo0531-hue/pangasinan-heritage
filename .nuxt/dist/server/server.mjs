import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, h, ref, isVNode, createCommentVNode, Suspense, Fragment, useSSRContext, defineAsyncComponent, unref, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "C:/Users/LENOVO/Downloads/pangasinan-heritage/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CH1vEAzL.js")
  },
  {
    name: "culture",
    path: "/culture",
    component: () => import("./_nuxt/culture-CsZ7C96f.js")
  },
  {
    name: "heritage-sites-id",
    path: "/heritage-sites/:id()",
    component: () => import("./_nuxt/_id_-BeU9Tfii.js")
  },
  {
    name: "heritage-sites",
    path: "/heritage-sites",
    component: () => import("./_nuxt/index-CplLhnDV.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CKal4CrL.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D4eZTYLX.js"));
